...
driver = webdriver.Firefox(executable_path=r'C:\Users\weile_000\Desktop\geckodriver-v0.24.0-win64\geckodriver.exe')
driver.get(url)
...
price_str = 'strike-it-red_anim change-text-color-gray'

for entry in html.find_all(['span', 'div', 'i'], {'class': ['sr-hotel__name', 'bui-review-score__badge', 'bk-icon-wrapper bk-icon-stars star_track', price_str]}):
